...
(setq background-diff-current-C "#eeee00")
(setq background-diff-even-A "#ddca69")
(setq background-diff-even-Ancestor "#dddddd")
(setq background-diff-even-B "#ddca69")
(setq background-diff-even-C "#ddca69")
...
(setq background-diff-odd-A "#ddca69")
(setq background-diff-odd-Ancestor "#ddca69")
(setq background-diff-odd-B "#ddca69")
(setq background-diff-odd-C "#ddca69")
(setq background-diff-removed "#dfac90")
