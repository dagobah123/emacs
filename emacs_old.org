...
#+BEGIN_SRC emacs-lisp
  ...
  ^Eglot^   ^Lsp^             ^Git^           ^Search^              ^Project^   ^Diff^            ^Build^
  ^^^^^--------------------------------------------------------------------------------------------------------
  _9_: ON   _i_: imenu        _g_: status     _1_: dired project    _p_: root   _E_: buffers      _-_: compile
  _0_: OFF  _s_: symbols      _l_: log        _2_: vc-git-grep      _f_: files  _A_: directories  _=_: lsp
