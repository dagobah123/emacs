...
(defun my:theme-switch1()
  (interactive)
  (my:disable-themes)
  (load-theme 'solarized-dark-high-contrast t))
(global-set-key (kbd "C-6") 'my:theme-switch1)

(defun my:theme-switch2()
  (interactive)
  (my:disable-themes)
  (load-theme 'dark-mint t))
(global-set-key (kbd "C-7") 'my:theme-switch2)

(defun my:theme-switch3()
  (interactive)
  (my:disable-themes)
  (load-theme 'doom-palenight t))
(global-set-key (kbd "C-8") 'my:theme-switch3)
#+END_SRC
** behavior
#+BEGIN_SRC emacs-lisp
(cua-mode t)
