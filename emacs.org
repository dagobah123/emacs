...
#+BEGIN_SRC emacs-lisp
  (defun my:find-files-in-project (directory extension)
    ...
    (interactive "DDirectory: \nsEnter file extension (e.g., py, js): ")
    (let ((file-list '()))
  ...
  (defun my:class-overview ()
    ...
    (let ((project-root (projectile-project-root))
      ...
      (if project-root
          (my:find-files-in-project project-root "java"))

      (message "Length of the list: %d" (length file-list)))
   
    ; TODO Store the files in a list
    ; TODO Remove the project root from the file paths
    ; TODO Parse each file for parents
