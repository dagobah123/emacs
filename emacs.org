...
#+BEGIN_SRC emacs-lisp
(defun my-vocabulary-creator-for-org-drill ()
  "Vocabulary creator for org-drill."
  (interactive)
  ...
  (let ((words (my-parse-text-into-list "/home/computer/source/org-mode/learn/texts/fr-guillermo"))
        (translation "")
    ...
    (with-temp-file "/home/computer/source/org-mode/learn/texts/output-sorted-words"
    ...
    ;; create new output file
    (with-temp-file "/home/computer/source/org-mode/learn/texts/output-translation"
    ...
    (setq translation-pairs (my-combine-lists-to-pair sorted-words translation-list))

    (dolist (pair translation-pairs)
      (message "%s %s" (car pair)(cadr pair)))
    
    ;; create org-drill files
    (dolist (pair translation-pairs)
      (setq org-drill-string (concat org-drill-string "* Q :drill:\n" (car pair) "\n** A\n" (cadr pair) "\n")))

    ;; create final output file
    (with-temp-file "/home/computer/source/org-mode/learn/texts/output-org-drill.org"
...
(defun my-parse-text-into-list (file-path)
  ...
  (message "[voc] Parse text into list... File path: %s" file-path)
  ...
  (with-temp-buffer
    ...
    (let ((result '()))
      ...
      (while (not (eobp))
        ...
        (let ((word (thing-at-point 'word t)))
          ...
          (when word
            ...
            (message "[voc] Current word... <%s>" word)
      ...
      ;; create new output file
      (with-temp-file "/home/computer/source/org-mode/learn/texts/output"
...
(defun my-sort-and-remove-duplicates (input-list)
  ...
  (let ((sorted-list (sort (copy-sequence input-list) 'string<)))
    ...
    (with-temp-file "/home/computer/source/org-mode/learn/texts/output-2"
