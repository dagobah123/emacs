...
(setq-default mode-line-format
    '("%e"
      ...
      " "
      (:eval (format "<%s>" (propertize (car (vc-git-branches)) 'face 'my:branch-face)))
      " "
      ;mode-line-position
      ;mode-line-modes
      mode-line-misc-info
...
;(:eval (list (my:major-mode-icon) mode-line-buffer-identification))
;(:eval (if vc-mode (list (my:vc-mode-icon) (propertize vc-mode 'face 'my:branch-face))))
