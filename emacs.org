...
(defun my-vocabulary-creator-for-org-drill ()
  "Vocabulary creator for org-drill."
  (interactive)
  ;;(my-clean-output-file (my-parse-text-into-list "/home/computer/source/org-mode/learn/texts/tintin"))
  (my-clean-output-file (my-parse-text-into-list "/home/computer/source/org-mode/learn/texts/test"))
#+END_SRC
...
(defun my-parse-text-into-list (file-path)
  ...
  (with-temp-buffer
    ...
    (let ((result '()))
      (while (not (eobp))
        (push (thing-at-point 'word t) result)
        (right-word))
      (with-temp-file "/home/computer/source/org-mode/learn/texts/output" (insert result))
      result)))
#+END_SRC
        ;;(setq result (concat result (thing-at-point 'word t) "\n"))

** my-clean-output-file
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
;;(write-file "/home/computer/source/org-mode/learn/texts/output2" (insert sorted-list)))))
