...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-x / 1") 'avy-goto-line)
  (global-set-key (kbd "C-x / 2") 'avy-move-line)
  (global-set-key (kbd "C-x / 3") 'avy-kill-whole-line)
  (global-set-key (kbd "C-x / 4") 'avy-kill-region)
  (global-set-key (kbd "C-x / 5") 'avy-pop-mark)
