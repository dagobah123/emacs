...
#+BEGIN_SRC emacs-lisp
  ...
  ^File^              ^Lsp^             ^Git^           ^Search^             ^Project^   ^Diff^            ^Build^
  ^^^^^----------------------------------------------------------------------------------------------------------------
  _a_: line numbers   _1_: ui-imenu     _k_: status     _q_: dired project   _t_: root   _y_: buffers      _p_: compile
  _s_: whitespace     _2_: references   _l_: log        _w_: vc-git-grep     _]_: files  _u_: directories  _[_: build
  _d_: imenu          _3_: definition   _;_: log file   _e_: helm-git-grep   ^ ^         _i_: branches     ^ ^
  _f_: treemacs       _4_: restart      _'_: blame      _r_: buffers         ^ ^         _o_: magit-diff   ^ ^
  _g_: focus          ^ ^               ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  _h_: cua            ^ ^               ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  _j_: overwrite      ^ ^               ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  "
