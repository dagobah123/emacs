...
;  '((t :foreground "yellow"))
;  "Custom face for mode-line-buffer-identification in mode-line."
;  :group 'my)
...
(setq-default mode-line-format
              '("%e"
                ...
                ;(:propertize (mode-line-buffer-identification) face my:buffer-face)
                (:propertize (vc-mode vc-mode) face my:branch-face)
                " "
                (:eval (format "%s" (propertize (capitalize (symbol-name major-mode)) 'face 'bold)))
                " "
                mode-line-position
                " "
                ;mode-line-modes
