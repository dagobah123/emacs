...
#+BEGIN_SRC emacs-lisp
  ...
  ^^^^^----------------------------------------------------------------------------------------------------------------
  _l_: line numbers   _1_: ui-imenu     _s_: status     _d_: dired project   _r_: root   _e_: buffers      _-_: compile
  _w_: whitespace     _2_: references   _l_: log        _v_: vc-git-grep     _f_: files  _D_: directories  _=_: build
  _i_: imenu          _3_: definition   _L_: log file   _h_: helm-git-grep   ^ ^         _B_: branches     ^ ^
  _t_: treemacs       _4_: restart      _b_: blame      _u_: buffers         ^ ^         _m_: magit-diff   ^ ^
  _C_: focus          ^ ^               ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  _c_: cua            ^ ^               ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  _o_: overwrite      ^ ^               ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  "
