...
(global-set-key (kbd "C-n") 'ivy-switch-buffer)
#+END_SRC
** look
#+BEGIN_SRC emacs-lisp
(menu-bar-mode 0)
...
(defun my:avy-lightning ()
  ...
  (set-face-attribute 'font-lock-bracket-face            nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-builtin-face            nil  :foreground text-lower ) 
  ...
  (set-face-attribute 'font-lock-constant-face           nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-doc-face                nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-function-call-face      nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-function-name-face      nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-keyword-face            nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-number-face             nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-preprocessor-face       nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-string-face             nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-type-face               nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-variable-name-face      nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-variable-use-face       nil  :foreground text-lower ) 
  (set-face-attribute 'font-lock-warning-face            nil  :foreground text-lower )
  
  (avy-goto-char-timer)
  (set-face-attribute 'default nil :foreground "#888888")
