...
#+BEGIN_SRC emacs-lisp
  ...
  _4_: errors       _b_: blame      _u_: buffers         ^ ^         _m_: magit-diff   ^ ^
  _5_: symbols      _g_: region     ^ ^                  ^ ^         ^ ^               ^ ^
  _6_: references   ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  _7_: implement.   ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  _8_: call hier.   ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  _9_: type hier.   ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  ...
  "
    ...
    ("4" (lsp-treemacs-errors-list))
    ("5" (lsp-treemacs-symbols))
    ("6" (lsp-treemacs-references))
    ("7" (lsp-treemacs-implementations))
    ("8" (lsp-treemacs-call-hierarchy))
    ("9" (lsp-treemacs-type-hierarchy))
    ("0" (lsp-treemacs-deps-list))
