   ...
   ((string-equal system-type "gnu/linux")
    (cond
     ...
     ((string-equal LINUX-VERSION "raspberrypi")
      (progn (setq default-font-size 300) (setq font-size 300))))))
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;;(grep-apply-setting 'grep-command "grep --color=auto -nH --null -e -r . --include *.java")
#+END_SRC
** ediff
#+BEGIN_SRC emacs-lisp
...
** chess
#+BEGIN_SRC emacs-lisp
(setq chess-default-piece-directory "/home/pi/source/emacs/xboard/")
(setq chess-default-piece-size 25)
#+END_SRC
** plantuml
#+BEGIN_SRC emacs-lisp
