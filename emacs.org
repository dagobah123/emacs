...
#+BEGIN_SRC emacs-lisp
  ...
  ^Git^           ^Search^             ^Project^   ^Diff^            ^Build^
  ^^^^^----------------------------------------------------------------------------------------------------------------
  _1_: ui-imenu     _s_: status     _d_: dired project   _r_: root   _e_: buffers      _-_: compile
  _2_: references   _l_: log        _v_: vc-git-grep     _f_: files  _D_: directories  _=_: build
  _3_: definition   _L_: log file   _h_: helm-git-grep   ^ ^         _B_: branches     ^ ^
  _4_: restart      _b_: blame      _u_: buffers         ^ ^         _m_: magit-diff   ^ ^
  ^ ^               _g_: file       ^ ^                  ^ ^         ^ ^               ^ ^
  "
