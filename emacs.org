...
#+BEGIN_SRC emacs-lisp
  ...
  (cond
    ((string-equal system-type "windows-nt")
      (progn
        (set-face-attribute 'org-table nil :font "Courier New-25")
        (set-face-attribute 'org-link nil :font "Courier New-25")
        (set-face-attribute 'org-block nil :font "Courier New-25")
      )
    )
    ((string-equal system-type "gnu/linux")
      (progn
