...
(defhydra hydra-emacs (:hint nil :color red)
  ...
  _s_: .emacs.d    _f_: chiaro...el    ^ ^                  _2_: Eclipse      _b_: bookmarks
...
(defun my:mode-line-format ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 ;; evil mode state
                 (propertize " <E> " 'face 'font-lock-constant-face)
...
;;(define-key my-prefix-map (kbd "C-!") 'my:decrease-font-size)
;;(define-key my-prefix-map (kbd "C-$") 'tab-new)
;;(define-key my-prefix-map (kbd "C-%") 'tab-close)
;;(define-key my-prefix-map (kbd "C-&") 'tab-rename)
;;(define-key my-prefix-map (kbd "C-'") 'c-display-defun-name)
(define-key my-prefix-map (kbd "1") 'swiper-all)
;;(define-key my-prefix-map (kbd "C-*") 'my:open-all-burly-bookmarks)
(define-key my-prefix-map (kbd "=") 'er/contract-region)
;;(define-key my-prefix-map (kbd "C-1") 'delete-other-windows)
