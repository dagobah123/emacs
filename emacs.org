...
#+BEGIN_SRC emacs-lisp
  ...
  ^^^^^-------------------------------------------------------------------------------------------------
  _i_: imenu        _g_: status     _d_: dired project   _p_: root   _e_: buffers      _-_: compile
  _s_: symbols      _l_: log        _v_: vc-git-grep     _f_: files  _A_: directories  _=_: lsp
  _r_: references   _L_: log file   _h_: helm-git-grep   ^ ^         _B_: branches     ^ ^
  _d_: definition   _b_: blame      _u_: buffers         ^ ^         _m_: magit-diff   ^ ^
  _E_: errors       _B_: region     ^ ^                  ^ ^         ^ ^               ^ ^
  _R_: references   ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  _I_: implemen.    ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  _C_: call hier.   ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
  _T_: type hier.   ^ ^             ^ ^                  ^ ^         ^ ^               ^ ^
