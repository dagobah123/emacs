...
(defun my:mode-line-format ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 '(:eval (propertize my:custom-mode-line-string 'face 'font-lock-constant-face)) ;; Jave method name
                 (propertize " %b " 'face 'font-lock-constant-face) ;; buffer
                 ;;'(:eval (propertize (substring vc-mode 5) 'face 'font-lock-constant-face)) ;; git branch
                 '(:eval (propertize (my:check-if-empty (substring vc-mode 5)) 'face 'font-lock-constant-face)) ;; git branch
