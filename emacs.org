...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my:set-highlight-regexp ()
    ;;highlight-matching-lines-regexp
    (highlight-regexp "gui" 'hi-yellow)
    (highlight-regexp "client" 'hi-green)
    (highlight-regexp "xxx" 'hi-salmon)
    (highlight-matching-lines-regexp "crash" 'hi-pink)
    (highlight-regexp "state" 'hi-blue))

  (add-hook 'itail-mode-hook 'my:set-highlight-regexp)
  (add-hook 'logview-mode-hook 'my:set-highlight-regexp)
#+END_SRC
** custom functions
#+BEGIN_SRC emacs-lisp
