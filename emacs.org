...
(global-set-key (kbd "C-6") 'my:theme-switch-solarized-dark-high-contrast)

(defun my:theme-switch-dark-mint()
  (interactive)
  (my:disable-themes)
  (load-theme 'dark-mint t))
(global-set-key (kbd "C-7") 'my:theme-switch-dark-mint)

(defun my:theme-switch-doom-palenight()
  (interactive)
  (my:disable-themes)
  (load-theme 'doom-palenight t))
(global-set-key (kbd "C-8") 'my:theme-switch-doom-palenight)
 
(defun my:theme-switch-eclipse()
  (interactive)
  (my:disable-themes)
  (load-theme 'eclipse t))
(global-set-key (kbd "C-9") 'my:theme-switch-eclipse)
 
(defun my:theme-switch-ubuntu()
  (interactive)
  (my:disable-themes)
  (load-theme 'ubuntu t))
(global-set-key (kbd "C-0") 'my:theme-switch-ubuntu)
