...
(defun my:toggle-themes()
  ...
  (if (eq theme-index 10) (setq theme-index 0))
)
(global-set-key (kbd "C-`") 'my:toggle-themes)
...
(defun my:theme-switch-doom-zenburn()
  (interactive)
  (my:disable-themes)
  (load-theme 'doom-zenburn t))
(global-set-key (kbd "C-9") 'my:theme-switch-doom-zenburn)

(defun my:theme-switch-doom-gruvbox()
  (interactive)
  (my:disable-themes)
  (load-theme 'doom-gruvbox t))
(global-set-key (kbd "C-0") 'my:theme-switch-doom-gruvbox)
 
(defun my:alect-light-alt()
  (interactive)
  (my:disable-themes)
  (load-theme 'alect-light-alt t))
(global-set-key (kbd "C--") 'my:alect-light-alt)
