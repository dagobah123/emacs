...
(defun my:print-themes-list()
  (interactive)
  (print themes-list)
  (print (length themes-list))
  (print (nth 3 themes-list))
)
...
(defun my:disable-themes()
  ...
  (disable-theme 'base16-atelier-dune-light)
...
(defun my:toggle-themes()
  ...
  (if (eq theme-index 1)
      (progn
          (load-theme (nth 0 themes-list) t)
          (message "%s" (nth 0 themes-list))
      )
  )

  (if (eq theme-index 2)
      (progn
          (load-theme (nth 1 themes-list) t)
          (message "%s" (nth 1 themes-list))
      )
  )

  (if (eq theme-index 3)
      (progn
          (load-theme (nth 2 themes-list) t)
          (message "%s" (nth 2 themes-list))
      )
  )

  (if (eq theme-index 4)
      (progn
          (load-theme (nth 3 themes-list) t)
          (message "%s" (nth 3 themes-list))
      )
  )

  (if (eq theme-index 5)
      (progn
          (load-theme (nth 4 themes-list) t)
          (message "%s" (nth 4 themes-list))
      )
  )

  (if (eq theme-index 6)
      (progn
          (load-theme (nth 5 themes-list) t)
          (message "%s" (nth 5 themes-list))
      )
  )

  (if (eq theme-index 7)
      (progn
          (load-theme (nth 6 themes-list) t)
          (message "%s" (nth 6 themes-list))
      )
  )

  (if (eq theme-index 8)
      (progn
          (load-theme (nth 7 themes-list) t)
          (message "%s" (nth 7 themes-list))
      )
  )

  (if (eq theme-index 9)
      (progn
          (load-theme (nth 8 themes-list) t)
          (message "%s" (nth 8 themes-list))
      )
  )

  (if (eq theme-index 10)
      (progn
          (load-theme (nth 9 themes-list) t)
          (message "%s" (nth 9 themes-list))
      )
  )

  (if (eq theme-index 11)
      (progn
          (load-theme (nth 10 themes-list) t)
          (message "%s" (nth 10 themes-list))
      )
  )

  (if (eq theme-index 12)
      (progn
          (load-theme (nth 11 themes-list) t)
          (message "%s" (nth 11 themes-list))
      )
  )

  (if (eq theme-index 13)
      (progn
          (load-theme (nth 12 themes-list) t)
          (message "%s" (nth 12 themes-list))
      )
  )

  (if (eq theme-index 14)
      (progn
          (load-theme (nth 13 themes-list) t)
          (message "%s" (nth 13 themes-list))
      )
  )
  ...
  (if (eq theme-index 15)
      (progn
          ...
          (load-theme (nth 14 themes-list) t)
          (message "%s" (nth 14 themes-list))
      )
  )

  (if (eq theme-index 16)
      (progn
          (load-theme (nth 15 themes-list) t)
          (message "%s" (nth 15 themes-list))
      )
  )

  (if (eq theme-index 17)
      (progn
          (load-theme (nth 16 themes-list) t)
          (message "%s" (nth 16 themes-list))
      )
  )

  (if (eq theme-index 18)
      (progn
          (load-theme (nth 17 themes-list) t)
          (message "%s" (nth 17 themes-list))
      )
  )

  (if (eq theme-index 19)
      (progn
          (load-theme (nth 18 themes-list) t)
          (message "%s" (nth 18 themes-list))
      )
  )

  (if (eq theme-index 20)
      (progn
          (setq theme-index 0)
          (message "emacs")
      )
