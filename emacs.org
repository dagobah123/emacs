...
(defun my:toggle-themes()
  ...
  ;(setq theme-index (+ theme-index 1))
  (my:disable-themes)
  (if (eq theme-index -1) (setq theme-index 17))
  ...
  (if (eq theme-index 12) (load-theme 'alect-black-alt t))
  (if (eq theme-index 13) (load-theme 'base16-3024 t))
  (if (eq theme-index 14) (load-theme 'base16-circus t))
  (if (eq theme-index 15) (load-theme 'base16-darkviolet t))
  (if (eq theme-index 16) (load-theme 'base16-apathy t))
  (if (eq theme-index 17) (load-theme 'base16-darkviolet t))
  (if (eq theme-index 18) (setq theme-index 0))
)
#+END_SRC
** behavior
#+BEGIN_SRC emacs-lisp
