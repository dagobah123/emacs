...
#+BEGIN_SRC emacs-lisp
  (require 'logview)
  (setq log-view-update-interval 1)
  (setq auto-revert-tail-mode 1)

;;  (defface my:logview-highlight
;;    '((t :foreground "white" :background "blue"))
;;    "Face for highlighting custom string in logview mode")
;;
;;  (defun my:logview-filter ()
;;    "Filter log messages by keyword and highlight matches"
;;    (interactive)
;;    (let ((keyword (read-string "Enter keyword: ")))
;;      (log-view-filter-apply
;;       (lambda ()
;;         (when (search-forward keyword nil t)
;;           (add-text-properties (match-beginning 0) (match-end 0)
;;                                '(face my:logview-highlight)))))))
#+END_SRC
** itail
#+BEGIN_SRC emacs-lisp
  (require 'itail)
