...
(setq text-line-number "#ff7256")
(setq text-low "#8b5a2b")
(setq text-lower "#8b7765")
(setq text-match "#ee0000")
(setq text-mode-line "#cd5c5c")
(setq text-mode-line-buffer "#cd5c5c")
(setq text-normal "#cd853f")
(setq text-preprocessor "#228b22")
(setq text-type "#d2691e")
(setq text-variable "#daa520")
(setq text-whitespace "#ffa500")
