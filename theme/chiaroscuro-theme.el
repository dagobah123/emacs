...
;;; Commentary:
;;; Code:
(load-file "~/.emacs.d/theme/theme_variables.el")
...
(if (> INDEX-CHIAROSCURO INDEX-DEFAULT)
   (progn
     (if (eq INDEX-CHIAROSCURO INDEX-ECLIPSE)
         (progn 
           (if (display-graphic-p)
               (progn
                 ;; if gui
                 (load-file "~/.emacs.d/theme/theme-default-diff-light.el")
                 (load-file "~/.emacs.d/theme/theme-eclipse.el"))
             (progn
               ;; if shell
               (load-file "~/.emacs.d/theme/theme-default-diff-light-console.el")
               (load-file "~/.emacs.d/theme/theme-console-light.el")))))
     (if (eq INDEX-CHIAROSCURO INDEX-GREEN)
         (progn (load-file "~/.emacs.d/theme/theme-default-diff-light.el")
                (load-file "~/.emacs.d/theme/theme-green.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-GRAY)
         (progn (load-file "~/.emacs.d/theme/theme-default-diff-middle.el")
                (load-file "~/.emacs.d/theme/theme-gray.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-LOW-CHROMA)
         (progn (load-file "~/.emacs.d/theme/theme-default-diff-dark.el")
                (load-file "~/.emacs.d/theme/theme-low-chroma.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-BLUE)
         (progn (load-file "~/.emacs.d/theme/theme-default-diff-dark.el")
                (load-file "~/.emacs.d/theme/theme-blue.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-NEON)
         (progn (load-file "~/.emacs.d/theme/theme-default-diff-dark.el")
                (load-file "~/.emacs.d/theme/theme-neon.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-HIGH-CONTRAST)
         (progn (load-file "~/.emacs.d/theme/theme-default-diff-light.el")
                (load-file "~/.emacs.d/theme/theme-high-contrast.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-COLOR-CHANGE-LIGHT)
         (progn (load-file "~/.emacs.d/theme/theme-default-diff-light.el")
                (load-file "~/.emacs.d/theme/theme-color-changer.el")))
     ...
     (if (eq INDEX-CHIAROSCURO INDEX-CONSOLE-DARK)
         (progn (load-file "~/.emacs.d/theme/theme-default-diff-dark.el")
                (load-file "~/.emacs.d/theme/theme-console-dark.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-RED)
         (progn (load-file "~/.emacs.d/theme/theme-default-diff-dark.el")
                (load-file "~/.emacs.d/theme/theme-red.el")))
