...
(setq background-hl "#400000")
(setq background-low "#222222")
(setq background-magit "#0a0a0a")
(setq background-magit-dark "#000000")
(setq background-mode-line "#111111")
(setq background-region "#700000")
(setq text-comment "#5f9400")
(setq text-constant "#bd4a42")
(setq text-function "#bc8f8f")
(setq text-highlight-1 "#0053c1")
(setq text-highlight-2 "#0f285e")
(setq text-highlight-3 "#8fab00")
(setq text-hl "#5d9d1e")
