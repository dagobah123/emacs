...
`(ac-selection-face ((t (:foreground ,text-highlight-2 :background ,background-low :bold t ))))
...
`(company-tooltip-selection ((t (:foreground ,text-highlight-1 :background unspecified ))))
...
`(dired-header ((t (:foreground ,text-highlight-1 :background unspecified :bold t ))))
...
`(info-xref ((t (:foreground ,color-blue-1 :background unspecified :underline t ))))
`(info-xref-visited ((t (:foreground ,color-blue-2 :background unspecified :underline t ))))
...
`(magit-branch-current ((t (:foreground ,color-yellow-1 :background unspecified :box (:line-width 1 :color ,color-yellow-1) ))))
`(magit-branch-local ((t (:foreground ,color-green-1 :background unspecified :box (:line-width 1 :color ,color-green-1) ))))
`(magit-branch-remote ((t (:foreground ,color-red-1 :background unspecified :box (:line-width 1 :color ,color-red-1) ))))
`(magit-branch-remote-head ((t (:foreground ,color-red-1 :background unspecified :box (:line-width 1 :color ,color-red-1) :bold t :italic t ))))
`(magit-branch-upstream ((t (:foreground ,color-blue-1 :background unspecified :box (:line-width 1 :color ,color-blue-1) ))))
