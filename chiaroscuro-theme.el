...
`(magit-diff-file-heading-selection ((t (:foreground ,text-1            :background ,nil :bold t                                               ))))
`(magit-diff-file-heading-highlight ((t (:foreground ,text-1            :background ,nil :bold t                                               ))))

`(magit-diff-hunk-heading           ((t (:foreground ,gray-1            :background ,background-5                                                  ))))
`(magit-diff-hunk-heading-selection ((t (:foreground ,text-1            :background ,background-4                                                  ))))
`(magit-diff-hunk-heading-highlight ((t (:foreground ,text-1            :background ,background-4                                                  ))))
...
`(flycheck-error                            ((t (:foreground ,text-error :bold t :italic t))))
`(lsp-lsp-flycheck-warning-unnecessary-face ((t (:foreground ,text-error :bold t :italic t))))
`(flycheck-fringe-info                      ((t (:foreground ,text-error))))
`(flycheck-fringe-warning                   ((t (:foreground ,text-error))))
`(flycheck-fringe-error                     ((t (:foreground ,text-error))))
...
`(ivy-minibuffer-match-face-1     ((t (:foreground ,text-match :background ,background-match :bold))))
`(ivy-minibuffer-match-face-2     ((t (:foreground ,text-match :background ,background-match :bold))))
`(ivy-minibuffer-match-face-3     ((t (:foreground ,text-match :background ,background-match :bold))))
`(ivy-minibuffer-match-face-4     ((t (:foreground ,text-match :background ,background-match :bold))))
