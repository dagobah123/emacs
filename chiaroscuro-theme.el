...
(custom-theme-set-faces 'chiaroscuro
  ...
  `(magit-branch-current              ((t (:foreground ,text-A-1  :box (:line-width 1 :color ,text-A-1)))))
  `(magit-branch-remote-head          ((t (:foreground ,text-A-1  :box (:line-width 1 :color ,text-A-1)))))
