...
(if (> INDEX-CHIAROSCURO INDEX-DEFAULT)
   (progn
     (if (eq INDEX-CHIAROSCURO INDEX-ECLIPSE)
         (progn 
           (if (display-graphic-p)
               (progn
                 ;; if gui
                 (load-file "~/.emacs.d/theme-default-diff-light.el")
                 (load-file "~/.emacs.d/theme-eclipse.el"))
             (progn
               ;; if shell
               (load-file "~/.emacs.d/theme-default-diff-light-console.el")
               (load-file "~/.emacs.d/theme-console-light.el")))))
     (if (eq INDEX-CHIAROSCURO INDEX-GREEN)
         (progn (load-file "~/.emacs.d/theme-default-diff-light.el")
                (load-file "~/.emacs.d/theme-green.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-GRAY)
         (progn (load-file "~/.emacs.d/theme-default-diff-middle.el")
                (load-file "~/.emacs.d/theme-gray.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-LOW-CHROMA)
         (progn (load-file "~/.emacs.d/theme-default-diff-dark.el")
                (load-file "~/.emacs.d/theme-low-chroma.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-BLUE)
         (progn (load-file "~/.emacs.d/theme-default-diff-dark.el")
                (load-file "~/.emacs.d/theme-blue.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-NEON)
         (progn (load-file "~/.emacs.d/theme-default-diff-dark.el")
                (load-file "~/.emacs.d/theme-neon.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-HIGH-CONTRAST)
         (progn (load-file "~/.emacs.d/theme-default-diff-light.el")
                (load-file "~/.emacs.d/theme-high-contrast.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-COLOR-CHANGE-LIGHT)
         (progn (load-file "~/.emacs.d/theme-default-diff-light.el")
                (load-file "~/.emacs.d/theme-color-changer.el")))
     ...
     (if (eq INDEX-CHIAROSCURO INDEX-CONSOLE-DARK)
         (progn (load-file "~/.emacs.d/theme-default-diff-dark.el")
                (load-file "~/.emacs.d/theme-console-dark.el")))
     (if (eq INDEX-CHIAROSCURO INDEX-RED)
         (progn (load-file "~/.emacs.d/theme-default-diff-dark.el")
                (load-file "~/.emacs.d/theme-red.el")))
