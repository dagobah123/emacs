...
(if (> INDEX-CHIAROSCURO INDEX-CONSOLE)
  ...
  (progn
    ...
    ;dired
    `(dired-directory    ((t (:foreground ,color-violet-1 :background, color-violet-2 :bold t ))))
    `(dired-flagged      ((t (:foreground ,color-red-1    :background, color-red-2            ))))
    `(dired-header       ((t (:foreground ,text-normal    :background, background-1           ))))
    `(dired-ignored      ((t (:foreground ,text-normal    :background, background-1           ))))
    `(dired-mark         ((t (:foreground ,color-red-1    :background, color-red-2            ))))
    `(dired-marked       ((t (:foreground ,color-red-1    :background, color-red-2            ))))
    `(dired-narrow-blink ((t (:foreground ,text-normal    :background, background-1           ))))
    `(dired-perm-write   ((t (:foreground ,text-normal    :background, background-1           ))))
    `(dired-set-id       ((t (:foreground ,text-normal    :background, background-1           ))))
    `(dired-symlink      ((t (:foreground ,text-normal    :background, background-1           ))))
    `(dired-warning      ((t (:foreground ,text-normal    :background, background-1           ))))
    `(dired-special      ((t (:foreground ,color-violet-1                                     ))))
    ...
    ;helm
    `(helm-minibuffer-prompt            ((t (:foreground ,text-normal    :background ,background-1                          ))))
    ...
    `(helm-swoop-line-number-face       ((t (:foreground ,text-normal    :background ,background-1                          ))))
    `(helm-swoop-target-line-block-face ((t (:foreground ,text-normal    :background ,background-1                          ))))
    ...
    `(ivy-match-required-face           ((t (:foreground ,color-yellow-1 :background ,color-yellow-2                        ))))
    ...
    `(helm-bookmark-directory           ((t (:foreground ,color-violet-1 :background, color-violet-2   :bold t              ))))
    ...
    ;elfeed
    `(elfeed-log-date-face            ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-log-debug-level-face     ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-log-error-level-face     ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-log-info-level-face      ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-log-warn-level-face      ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-search-date-face         ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-search-feed-face         ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-search-filter-face       ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-search-last-update-face  ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-search-tag-face          ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-search-title-face        ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-search-unread-count-face ((t (:foreground ,text-normal :background ,background-1 ))))
    `(elfeed-search-unread-title-face ((t (:foreground ,text-normal :background ,background-1 ))))
    ...
    `(magit-branch-current              ((t (:foreground ,color-green-1     :background ,color-green-2                     :box (:line-width 1 :color ,color-green-1) ))))
    ...
    `(magit-branch-upstream             ((t (:foreground ,color-red-1       :background ,color-red-2                       :box (:line-width 1 :color ,color-red-1)   ))))
    `(magit-section-highlight           ((t (:foreground ,text-highlight-2  :background ,background-magit                  :bold t                                    ))))
    ...
    `(ediff-current-diff-Ancestor ((t (:foreground ,text-ediff :background ,color-violet-2            ))))
    ...
    `(ediff-even-diff-Ancestor    ((t (:foreground ,text-ediff :background ,color-violet-2            ))))
    ...
    `(ediff-fine-diff-Ancestor    ((t (:foreground ,text-ediff :background ,color-violet-2            ))))
    ...
    ;ztree
    `(ztreep-diff-model-add-face     ((t (:foreground ,color-violet-1 :background ,color-violet-2               ))))
    ...
    `(org-mode-line-clock           ((t (:foreground ,text-mode-line :background ,background-mode-line :box (:line-width 1 :color ,text-mode-line-border)  :bold t ))))
    `(org-mode-line-clock-overrun   ((t (:foreground ,text-mode-line :background ,"#ff2222"            :box (:line-width 1 :color ,text-mode-line-border)  :bold t ))))
    ...
    `(mode-line-buffer-id            ((t (:foreground ,text-mode-line  :background ,background-buffer-id-projectile :box (:line-width 1 :color ,text-mode-line-border) :bold t ))))
    `(telephone-line-projectile      ((t (:foreground ,text-mode-line  :background ,background-buffer-id-projectile :box (:line-width 1 :color ,text-mode-line-border) :bold t ))))
    ...
    `(lsp-lsp-flycheck-warning-unnecessary-face ((t (:foreground ,color-orange-1 :bold t :underline t ))))
    `(flycheck-fringe-info                      ((t (:foreground ,color-blue-1   :bold t              ))))
    `(flycheck-fringe-warning                   ((t (:foreground ,color-orange-1 :bold t              ))))
    `(flycheck-fringe-error                     ((t (:foreground ,color-red-1    :bold t              ))))
    ...
    `(avy-lead-face                  ((t (:foreground ,color-blue-1   :background ,color-blue-2   ))))
    `(avy-lead-face-0                ((t (:foreground ,color-yellow-1 :background ,color-yellow-2 ))))
    ...
    `(swiper-line-face               ((t (:foreground ,color-green-1  :background ,color-green-2  ))))
    ...
    `(treemacs-root-face                ((t (:foreground ,color-violet-1       :background unspecified           :bold t ))))
    ...
    `(treemacs-git-modified-face        ((t (:foreground ,color-violet-1       :background ,color-violet-2               ))))
