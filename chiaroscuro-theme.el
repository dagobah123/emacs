...
`(hl-line ((t (:foreground ,text-match-2 :background ,background-match-2 ))))
...
`(magit-branch-remote ((t (:foreground ,text-highlight-1 :background unspecified :bold t :box (:line-width 1 :color ,text-highlight-1) ))))
`(magit-branch-remote-head ((t (:foreground ,text-highlight-1 :background unspecified :bold t :box (:line-width 1 :color ,text-highlight-1) :bold t :italic t ))))
...
`(region ((t (:foreground ,text-match-1 :background ,background-match-1 ))))
