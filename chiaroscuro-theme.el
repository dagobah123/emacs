...
`(iedit-occurrence ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
...
`(swiper-background-match-face-1 ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(swiper-background-match-face-2 ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(swiper-background-match-face-3 ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(swiper-background-match-face-4 ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(swiper-line-face ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(swiper-match-face-1 ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(swiper-match-face-2 ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(swiper-match-face-3 ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
`(swiper-match-face-4 ((t (:foreground ,text-hl :background ,background-hl :bold t ))))
...
`(tab-bar-tab-group-current ((t (:foreground ,text-highlight-2 :background unspecified ))))
`(tab-bar-tab-group-inactive ((t (:foreground ,text-highlight-2 :background unspecified ))))
`(tab-bar-tab-inactive ((t (:foreground ,text-highlight-2 :background ,background-mode-line :box (:line-width 8 :color ,background-mode-line) ))))
`(tab-bar-tab-ungrouped ((t (:foreground ,text-highlight-2 :background unspecified ))))
`(tab-line ((t (:foreground ,text-highlight-2 :background unspecified ))))
