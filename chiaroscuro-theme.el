...
(custom-theme-set-faces 'chiaroscuro
  ...
  `(helm-selection                    ((t (:foreground ,text-C-1 :background ,background-B-1 :bold t    ))))
  `(helm-swoop-target-line-face       ((t (:foreground ,text-C-1 :bold t                                 ))))
  `(helm-swoop-target-word-face       ((t (:foreground ,text-C-1 :background ,background-B-1             ))))
