...
;;`(bm-face ((t (:foreground ,color-green-1 :background unspecified ))))
;;`(bm-persistent-face ((t (:foreground ,color-red-1 :background unspecified ))))
;;`(company-preview ((t (:foreground ,color-red-1 :background ,background-fringe ))))
;;`(company-preview-common ((t (:foreground ,color-red-1 :background ,background-fringe ))))
;;`(company-preview-search ((t (:foreground ,color-red-1 :background ,background-fringe ))))
;;`(cua-global-mark ((t (:foreground ,color-green-1 :background unspecified ))))
;;`(git-commit-summary ((t (:foreground ,color-blue-1 :background unspecified ))))
;;`(git-gutter:added ((t (:foreground ,color-green-1 :background unspecified :bold t ))))
;;`(git-gutter:deleted ((t (:foreground ,color-red-1 :background unspecified :bold t ))))
;;`(git-gutter:modified ((t (:foreground ,color-green-1 :background unspecified :bold t ))))
;;`(git-gutter:separator ((t (:foreground ,text-highlight-1 :background unspecified :bold t ))))
;;`(git-gutter:unchanged ((t (:foreground ,color-blue-1 :background unspecified :bold t ))))
;;`(helm-bookmark-info ((t (:foreground ,color-blue-1 :background unspecified ))))
;;`(helm-completions-detailed ((t (:foreground ,color-blue-1 :background unspecified :bold nil ))))
;;`(helm-ff-denied ((t (:foreground ,color-yellow-1 :background unspecified ))))
;;`(helm-ff-file ((t (:foreground ,color-blue-1 :background unspecified :bold nil ))))
;;`(helm-header-line-left-margin ((t (:foreground ,color-green-1 :background unspecified ))))
;;`(helm-lisp-completion-info ((t (:foreground ,color-yellow-1 :background unspecified ))))
;;`(helm-swoop-line-number-face ((t (:foreground ,color-orange-1 :background unspecified ))))
;;`(lsp-treemacs-file-error ((t (:foreground ,"#ffffff" ))))
;;`(markdown-highlighting-face ((t (:foreground ,color-green-1 :background unspecified ))))
;;`(org-agenda-calendar-event ((t (:foreground ,color-blue-1 ))))
;;`(org-agenda-calendar-sexp ((t (:foreground ,color-blue-1 ))))
;;`(org-agenda-clocking ((t (:foreground ,color-green-1 :background unspecified ))))
...
;;`(org-mode-line-clock ((t (:foreground ,color-green-1 :background unspecified :bold t ))))
;;`(org-mode-line-clock-overrun ((t (:foreground ,color-red-1 :background unspecified :bold t ))))
...
;;`(org-table ((t (:foreground ,color-blue-1 :background unspecified ))))
;;`(org-table-header ((t (:foreground ,color-green-1 :background unspecified ))))
...
;;`(ztreep-diff-model-diff-face ((t (:foreground ,color-yellow-1 :background unspecified ))))
...
`(company-tooltip-common ((t (:foreground ,text-highlight-2 :background ,background-fringe :bold t ))))
...
`(compilation-warning ((t (:foreground ,text-warning :bold t :underline t ))))
...
`(diff-added ((t (:foreground unspecified :background ,background-diff-added-highlight ))))
...
`(diff-indicator-added ((t (:foreground unspecified :background ,background-diff-added-highlight ))))
`(diff-indicator-removed ((t (:foreground unspecified :background ,background-diff-removed-highlight ))))
`(diff-refine-added ((t (:foreground unspecified :background ,background-diff-added-highlight ))))
`(diff-refine-removed ((t (:foreground unspecified :background ,background-diff-removed-highlight ))))
`(diff-removed ((t (:foreground unspecified :background ,background-diff-removed-highlight ))))
...
`(eglot-mode-line ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
...
`(helm-M-x-key ((t (:foreground ,text-highlight-2 ))))
...
`(helm-match-item ((t (:foreground ,text-highlight-1 :background unspecified :bold t ))))
...
`(hl-line ((t (:foreground ,text-highlight-1 :background ,background-hl ))))
...
`(ido-only-match ((t (:foreground ,text-highlight-1 :background unspecified ))))
...
`(ivy-current-match ((t (:foreground ,text-highlight-1 :background unspecified :bold t ))))
...
`(ivy-minibuffer-match-face-1 ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
`(ivy-minibuffer-match-face-2 ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
`(ivy-minibuffer-match-face-3 ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
`(ivy-minibuffer-match-face-4 ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
...
`(region ((t (:foreground ,text-highlight-1 :background ,background-region ))))
...
`(swiper-background-match-face-1 ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
`(swiper-background-match-face-2 ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
`(swiper-background-match-face-3 ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
`(swiper-background-match-face-4 ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
`(swiper-line-face ((t (:foreground ,text-highlight-1 :background unspecified :bold t ))))
`(swiper-match-face-1 ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
`(swiper-match-face-2 ((t (:foreground ,text-highlight-2 :background unspecified :bold t ))))
...
`(tab-bar-tab-group-current ((t (:foreground ,text-mode-line :background unspecified ))))
`(tab-bar-tab-group-inactive ((t (:foreground ,text-mode-line :background unspecified ))))
`(tab-bar-tab-inactive ((t (:foreground ,text-mode-line :background ,background-mode-line :box (:line-width 8 :color ,background-mode-line) ))))
`(tab-bar-tab-ungrouped ((t (:foreground ,text-mode-line :background unspecified ))))
`(tab-line ((t (:foreground ,text-mode-line :background unspecified ))))
...
`(transient-red ((t (:foreground ,color-yellow-1 :background unspecified ))))
