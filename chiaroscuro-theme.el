...
`(mode-line ((t (:foreground ,text-highlight-1 :background ,background-mode-line-active ))))
...
`(tab-bar ((t (:foreground ,text-normal :background ,background-mode-line-active ))))
`(tab-bar-tab ((t (:foreground ,text-highlight-1 :background ,background-mode-line-active :bold t ))))
...
`(tab-bar-tab-inactive ((t (:foreground ,text-mode-line :background ,background-mode-line-active ))))
