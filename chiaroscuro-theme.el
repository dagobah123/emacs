...
`(ivy-modified-buffer ((t (:foreground ,color-violet-1 :background unspecified :bold t :italic t ))))
`(ivy-modified-outside-buffer ((t (:foreground ,color-violet-1 :background unspecified :bold t :italic t ))))
...
`(shr-link ((t (:foreground ,text-highlight-2 :background ,background :underline t ))))
