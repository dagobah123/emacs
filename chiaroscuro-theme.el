...
(if (> CHIAROSCURO-INDEX CONSOLE-INDEX)
  ...
  (progn
    ...
    `(helm-source-header                ((t (:foreground ,text-low     :bold t                       :height 200  ))))
    ...
    `(magit-blame-heading               ((t (:foreground ,blue-1            :background ,blue-2 :bold t                         ))))
    `(magit-blame-highlight             ((t (:foreground ,blue-1            :background ,blue-2 :bold t                         ))))
    `(magit-blame-margin                ((t (:foreground ,blue-1            :background ,blue-2 :bold t                         ))))
