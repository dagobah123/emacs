...
(if (eq CHIAROSCURO_INDEX 6) ;karekare
    (progn
        ...
        (setq background-4 "#ff6044")
        (setq background-5 "#314d1d")
        (setq background-match "#98b53f")
...
(if (eq CHIAROSCURO_INDEX 5) ;pablo
    (progn
        (setq text-1 "#e5c1a7")
        (setq text-2 "#929f85")
        (setq text-3 "#929f85")
        (setq text-match "#ffffff")
        (setq background-1 "#715f55")
        (setq background-2 "#493b3a")
        (setq background-3 "#493b3a")
        (setq background-4 "#cd8366")
        (setq background-5 "#865d41")
        (setq background-match "#929f85")
        (setq background-cursor "#ffffff")
        (setq green-1 "#98b53f")
        (setq green-2 "#4e7830")
        (setq red-1 "#fd8667")
        ...
        (setq violet-1 "#aa8db8")
        (setq violet-2 "#5a4366")
        (setq line-number-1 "#fdf2e0")
        (setq line-number-2 "#865d41")
        (setq line-number-3 "#465f63")
        (setq line-number-4 "#929f85")
        ;(setq org-todo-keyword-faces '(("IN-PROGRESS" . (:foreground "#22aa22" :weight bold))))
  )
)
...
(if (eq CHIAROSCURO_INDEX 4) ;pop
    (progn
        ...
        (setq blue-1 "#faf0ff")
        (setq blue-2 "#9494d0")
        (setq yellow-1 "#fff6d7")
        (setq yellow-2 "#dbb92c")
