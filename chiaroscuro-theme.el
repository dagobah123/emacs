...
(if (> INDEX-CHIAROSCURO INDEX-DEFAULT)
  ...
  (progn
    ...
    ;`(cursor                   ((t (:background unspecified-cursor                                        ))))
    ...
    `(helm-buffer-directory             ((t (:foreground ,color-red-1                          ))))
    `(helm-ff-directory                 ((t (:foreground ,color-red-1                          ))))
    `(helm-ff-dotted-directory          ((t (:foreground ,text-match     :background ,background-match                      ))))
    `(helm-ff-file-extension            ((t (:foreground ,color-orange-1  :background unspecified :bold nil                        ))))
    `(helm-ff-file                      ((t (:foreground ,color-blue-1  :background unspecified :bold nil                        ))))
    `(helm-buffer-file                  ((t (:foreground ,text-highlight-1  :background unspecified :bold t                       ))))
    ...
    `(ivy-current-match                 ((t (:foreground ,text-match           :background ,text-highlight-1      :bold t   ))))
    `(ivy-minibuffer-match-face-1       ((t (:foreground ,text-match           :background ,text-highlight-1                   ))))
    `(ivy-minibuffer-match-face-2       ((t (:foreground ,text-match           :background ,text-highlight-1                     ))))
    `(ivy-minibuffer-match-face-3       ((t (:foreground ,text-match           :background ,text-highlight-1                    ))))
    `(ivy-minibuffer-match-face-4       ((t (:foreground ,text-match           :background ,text-highlight-1                  ))))
    ...
    `(ivy-subdir                        ((t (:foreground ,color-red-1                          ))))

    `(swiper-background-match-face-1    ((t (:foreground ,text-match     :background ,text-highlight-1                   ))))
    `(swiper-background-match-face-2    ((t (:foreground ,text-match     :background ,text-highlight-1                  ))))
    `(swiper-background-match-face-3    ((t (:foreground ,text-match     :background ,text-highlight-1                  ))))
    `(swiper-background-match-face-4    ((t (:foreground ,text-match     :background ,text-highlight-1                  ))))
    `(swiper-match-face-1               ((t (:foreground ,text-match     :background ,text-highlight-1                  ))))
    `(swiper-match-face-2               ((t (:foreground ,text-match     :background ,text-highlight-1                  ))))
    `(swiper-match-face-3               ((t (:foreground ,text-match     :background ,text-highlight-1                  ))))
    `(swiper-match-face-4               ((t (:foreground ,text-match     :background ,text-highlight-1                  ))))
    ...
    `(ac-completion-face      ((t (:foreground ,"#000000"   :background ,text-highlight-2 :bold t ))))
    `(ac-selection-face       ((t (:foreground ,"#000000"   :background ,text-highlight-1 :bold t ))))
  )
