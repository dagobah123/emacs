   ...
   (progn
     (if (eq INDEX-CHIAROSCURO INDEX-ECLIPSE)
         (progn 
           (if (display-graphic-p)
             ...
             (progn
               ;; if shell
               (load-file "~/.emacs.d/theme/common/diff-light-console.el")
     ...
     (if (eq INDEX-CHIAROSCURO INDEX-GREEN)
         (progn (load-file "~/.emacs.d/theme/common/diff-light.el")
                (load-file "~/.emacs.d/theme/light/green.el")))
     ...
     (if (eq INDEX-CHIAROSCURO INDEX-LOW-CHROMA)
         (progn (load-file "~/.emacs.d/theme/common/diff-dark.el")
     ...
     (if (eq INDEX-CHIAROSCURO INDEX-HIGH-CONTRAST)
         (progn (load-file "~/.emacs.d/theme/common/diff-light.el")
                (load-file "~/.emacs.d/theme/dark/high-contrast.el")))
