...
`(org-level-1                   ((t (:foreground ,green-1  :background ,background-7 :bold t              ))))
`(org-level-2                   ((t (:foreground ,red-1    :background ,background-7 :bold t              ))))
`(org-level-3                   ((t (:foreground ,blue-1   :background ,background-7 :bold t              ))))
`(org-level-4                   ((t (:foreground ,yellow-1 :background ,background-7 :bold t              ))))
`(org-level-5                   ((t (:foreground ,violet-1 :background ,background-7 :bold t              ))))
`(org-level-6                   ((t (:foreground ,orange-1 :background ,background-7 :bold t              ))))
`(org-level-7                   ((t (:foreground ,gray-1   :background ,background-7 :bold t              ))))
`(org-level-8                   ((t (:foreground ,green-1  :background ,background-7 :bold t              ))))
