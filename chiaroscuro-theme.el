...
(if (> INDEX-CHIAROSCURO INDEX-DEFAULT)
  ...
  (progn
    ...
    `(helm-swoop-target-line-face       ((t (:foreground ,color-blue-1     :background ,color-blue-2 :bold t                      ))))
    ...
    `(swiper-line-face                  ((t (:foreground ,color-blue-1  :background ,color-blue-2 :bold t               ))))
