...
`(dired-flagged ((t (:foreground ,color-red-1 :background unspecified ))))
...
`(dired-mark ((t (:foreground ,color-red-1 :background unspecified ))))
`(dired-marked ((t (:foreground ,color-red-1 :background unspecified ))))
...
`(magit-branch-upstream ((t (:foreground ,color-blue-1 :background unspecified :bold t :box (:line-width 1 :color ,color-blue-1) ))))
...
`(mode-line ((t (:foreground ,text-highlight-1 :background ,background-mode-line ))))
...
`(tab-bar-tab ((t (:foreground ,text-highlight-1 :background ,background-mode-line :bold t ))))
...
`(tab-bar-tab-inactive ((t (:foreground ,text-mode-line :background ,background-mode-line ))))
