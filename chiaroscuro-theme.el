...
(custom-theme-set-faces 'chiaroscuro
  ...
  `(minibuffer-prompt            ((t (:foreground ,text-A-1   :background ,background-A-1))))
  ...
  `(line-number                  ((t (:foreground ,text-C-1   :background ,background-A-1))))
  `(line-number-current-line     ((t (:foreground ,yellow-A-1 :background ,yellow-A-2))))
  `(line-number-major-tick       ((t (:foreground ,text-B-1   :background ,background-A-1))))
  `(line-number-minor-tick       ((t (:foreground ,text-B-1   :background ,background-A-1))))
  ...
  ;helm
  `(helm-minibuffer-prompt            ((t (:foreground ,text-A-1 :background ,background-A-1             ))))
  ...
  `(magit-section-highlight           ((t (                       :background ,background-B-1 :bold t                                       ))))
  ...
  `(magit-diff-added                  ((t (:foreground ,text-B-1  :background ,background-B-1                                               ))))
  `(magit-diff-removed-highlight      ((t (:foreground ,red-A-1   :background ,red-A-2                                                      ))))
  `(magit-diff-removed                ((t (:foreground ,text-B-1  :background ,background-B-1                                               ))))
  ...
  `(org-agenda-done                   ((t (:foreground ,text-B-1  :background ,nil                                                                          ))))
  ...
  `(org-archived                      ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  ...
  `(org-checkbox                      ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  ...
  `(org-clock-overlay                 ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-code                          ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-column                        ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-column-title                  ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-date                          ((t (:foreground ,red-A-1   :background ,red-A-2                           :underline t                                  ))))
  `(org-date-selected                 ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-default                       ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-document-info                 ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-document-info-keyword         ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-document-title                ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-done                          ((t (:foreground ,text-B-1                              :bold t                                       ))))
  `(org-drawer                        ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-ellipsis                      ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-footnote                      ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-formula                       ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-headline-done                 ((t (:foreground ,text-B-1  :background ,background-A-1 ))))
  `(org-headline-todo                 ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-hide                          ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-latex-and-related             ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-level-1                       ((t (:foreground ,green-A-1  :background ,nil :bold t))))
  `(org-level-2                       ((t (:foreground ,red-A-1    :background ,nil :bold t))))
  `(org-level-3                       ((t (:foreground ,blue-A-1   :background ,nil :bold t))))
  `(org-level-4                       ((t (:foreground ,yellow-A-1 :background ,nil :bold t))))
  `(org-level-5                       ((t (:foreground ,green-A-1  :background ,nil :bold t))))
  `(org-level-6                       ((t (:foreground ,red-A-1    :background ,nil :bold t))))
  `(org-level-7                       ((t (:foreground ,blue-A-1   :background ,nil :bold t))))
  `(org-level-8                       ((t (:foreground ,yellow-A-1 :background ,nil :bold t))))
  `(org-link                          ((t (:foreground ,blue-A-1  :background ,blue-A-2 :bold t :underline t))))
  `(org-list-dt                       ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-macro                         ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-meta-line                     ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-mode-line-clock               ((t (:foreground ,text-A-1  :background ,background-B-1 ))))
  `(org-mode-line-clock-overrun       ((t (:foreground ,red-A-2  :background ,red-A-1 ))))
  `(org-priority                      ((t (:foreground ,yellow-A-1  :background ,yellow-A-2 ))))
  `(org-property-value                ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-quote                         ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-scheduled                     ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-scheduled-previously          ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-scheduled-today               ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-sexp-date                     ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-special-keyword               ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-table                         ((t (:foreground ,green-A-1  :background ,green-A-2 ))))
  `(org-table-header                  ((t (:foreground ,green-A-1  :background ,green-A-2 ))))
  `(org-tag                           ((t (:foreground ,text-B-1  :background ,background-A-1 ))))
  `(org-tag-group                     ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-target                        ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-time-grid                     ((t (:foreground ,text-B-1  :background ,background-A-1 ))))
  `(org-todo                          ((t (:foreground ,red-A-1                               :bold t                                       ))))
  `(org-upcoming-deadline             ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-upcoming-distant-deadline     ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-verbatim                      ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-verse                         ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  `(org-warning                       ((t (:foreground ,text-A-1  :background ,background-A-1 ))))
  ...
  ;`(ivy-action                     ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-completions-annotations    ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-confirm-face               ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  `(ivy-current-match               ((t (:foreground ,green-A-1  :background ,green-A-2           ))))
  ;`(ivy-cursor                     ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-grep-info                  ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-grep-line-number           ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  `(ivy-highlight-face              ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-match-required-face        ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  `(ivy-minibuffer-match-face-1     ((t (:foreground ,blue-A-1   :background ,blue-A-2       :bold))))
  `(ivy-minibuffer-match-face-2     ((t (:foreground ,green-A-1  :background ,green-A-2      :bold))))
  `(ivy-minibuffer-match-face-3     ((t (:foreground ,red-A-1    :background ,red-A-2        :bold))))
  `(ivy-minibuffer-match-face-4     ((t (:foreground ,yellow-A-1 :background ,yellow-A-2     :bold))))
  ;`(ivy-minibuffer-match-highlight ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-modified-buffer            ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-modified-outside-buffer    ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-org                        ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-prompt-match               ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-remote                     ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-separator                  ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-subdir                     ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-virtual                    ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
  ;`(ivy-yanked-word                ((t (:foreground ,text-A-1   :background ,background-A-1      ))))
