...
(if (> INDEX-CHIAROSCURO INDEX-DEFAULT)
  ...
  (progn
    ...
    `(helm-candidate-number             ((t (:foreground ,color-green-1                                                       ))))
    ...
    `(helm-buffer-directory             ((t (:foreground ,color-red-1     :background ,color-red-2                      ))))
    `(helm-ff-directory                 ((t (:foreground ,color-red-1     :background ,color-red-2                      ))))
    `(helm-ff-dotted-directory          ((t (:foreground ,text-match     :background ,background-match                      ))))
    `(helm-ff-file-extension            ((t (:foreground ,text-highlight-1  :background unspecified :bold nil                        ))))
    `(helm-ff-file                      ((t (:foreground ,text-highlight-1  :background unspecified :bold nil                        ))))
