...
`(ediff-current-diff-Ancestor ((t (:foreground ,text-1 :background ,background-2))))
...
`(ediff-even-diff-A           ((t (:foreground ,text-1 :background ,background-2))))
`(ediff-even-diff-Ancestor    ((t (:foreground ,text-1 :background ,background-2))))
`(ediff-even-diff-B           ((t (:foreground ,text-1 :background ,background-2))))
`(ediff-even-diff-C           ((t (:foreground ,text-1 :background ,background-2))))
`(ediff-fine-diff-A           ((t (:foreground ,text-1 :background ,background-fine-diff-A))))
`(ediff-fine-diff-Ancestor    ((t (:foreground ,text-1 :background ,background-2))))
...
`(ediff-odd-diff-A            ((t (:foreground ,text-1 :background ,background-2))))
`(ediff-odd-diff-Ancestor     ((t (:foreground ,text-1 :background ,background-2))))
`(ediff-odd-diff-B            ((t (:foreground ,text-1 :background ,background-2))))
`(ediff-odd-diff-C            ((t (:foreground ,text-1 :background ,background-2))))
