...
(if (eq CHIAROSCURO_INDEX 8) ;orange
    (progn
        (setq text-1 "#f98801")
        (setq text-2 "#89918f")
        (setq text-3 "#aa6008")
...
(if (eq CHIAROSCURO_INDEX 4) ;karekare
    (progn
        (setq text-1 "#c0e347")
        (setq text-2 "#b2c4e0")
        (setq text-3 "#6e9714")
...
(custom-theme-set-faces 'chiaroscuro
  ...
  `(line-number-current-line     ((t (:foreground ,line-number-1 :background ,line-number-2           ))))
  ...
  `(font-lock-constant-face             ((t (:foreground ,orange-1     :background ,orange-2          ))))
  ...
  `(magit-blame-heading               ((t (:foreground ,green-1  :background ,green-2  :bold t                                            ))))
  `(magit-blame-highlight             ((t (:foreground ,green-1  :background ,green-2  :bold t                                            ))))
  `(magit-blame-margin                ((t (:foreground ,green-1  :background ,green-2  :bold t                                            ))))
  ...
  `(org-block                         ((t (:foreground ,text-1  :background ,background-5 ))))
