...
(if (> CHIAROSCURO-INDEX CONSOLE-INDEX)
  ...
  (progn
    ...
    `(org-level-1                   ((t (:foreground ,text-2   :background ,nil          :bold t              ))))
    `(org-level-2                   ((t (:foreground ,text-2   :background ,nil          :bold t              ))))
    `(org-level-3                   ((t (:foreground ,text-2   :background ,nil          :bold t              ))))
    ...
    `(org-imminent-deadline         ((t (:foreground ,alert-1        :background ,nil          :bold t                                                                    ))))
    `(org-upcoming-deadline         ((t (:foreground ,alert-2        :background ,nil                                                                                     ))))
    `(org-upcoming-distant-deadline ((t (:foreground ,alert-3        :background ,nil                                                                                     ))))
