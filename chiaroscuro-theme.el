...
(if (eq CHIAROSCURO_INDEX 2) ;light
    (progn
        ...
        (setq background-mode-line-fringe "#f7f7f7")
        (setq green-1 "#000000")
        (setq green-2 "#9bff83")
        (setq red-1 "#fb2463")
        (setq red-2 "#ffffff")
...
(custom-theme-set-faces 'chiaroscuro
  ...
  `(font-lock-keyword-face              ((t (:foreground ,yellow-1     :background ,yellow-2 :bold t  66))))
  ...
  `(font-lock-type-face                 ((t (:foreground ,red-1        :background ,red-2    :bold t :underline t :italic t))))
