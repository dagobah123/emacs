...
`(org-checkbox-statistics-done  ((t (:foreground ,text-1   :background ,nil                               ))))
`(org-checkbox-statistics-todo  ((t (:foreground ,text-1   :background ,nil                               ))))
...
`(org-default                   ((t (:foreground ,text-1   :background ,nil                               ))))
...
`(org-link                      ((t (:foreground ,red-1    :background ,blue-2       :bold t :underline t ))))
...
`(org-quote                     ((t (:foreground ,text-1   :background ,nil                               ))))
`(org-scheduled                 ((t (:foreground ,text-1   :background ,nil                               ))))
`(org-scheduled-previously      ((t (:foreground ,red-1    :background ,nil                               ))))
...
`(org-target                    ((t (:foreground ,text-1   :background ,nil                               ))))
`(org-time-grid                 ((t (:foreground ,text-3   :background ,nil                               ))))
`(org-todo                      ((t (:foreground ,red-1    :background ,nil          :bold t              ))))
`(org-upcoming-deadline         ((t (:foreground ,orange-1 :background ,nil                               ))))
`(org-upcoming-distant-deadline ((t (:foreground ,red-1    :background ,nil                               ))))
`(org-verbatim                  ((t (:foreground ,text-1   :background ,nil                               ))))
`(org-verse                     ((t (:foreground ,text-1   :background ,nil                               ))))
`(org-warning                   ((t (:foreground ,text-1   :background ,nil                               ))))
