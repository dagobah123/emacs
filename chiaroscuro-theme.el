...
(if (eq CHIAROSCURO_INDEX 6) ;pop
    (progn
        ...
        (setq yellow-2 "#ff9cff")
        (setq violet-1 "#ffffff")
        (setq violet-2 "#ff9cff")
        (setq orange-1 "#ffffff")
        (setq orange-2 "#ff9cff")
...
(if (eq CHIAROSCURO_INDEX 3) ;karekare
    (progn
        (setq text-1 "#c0e347")
        (setq text-2 "#b2c4e0")
        (setq text-3 "#6e9714")
...
(if (eq CHIAROSCURO_INDEX 2) ;terminal
    (progn
        ...
        (setq blue-1 "#8d8dc9")
        (setq blue-2 "#0a0082")
        (setq yellow-1 "#a2a242")
        (setq yellow-2 "#424000")
        (setq violet-1 "#dc67dc")
        (setq violet-2 "#43006d")
        (setq orange-1 "#b68e57")
        (setq orange-2 "#583000")
        (setq line-number-1 "#000000")
