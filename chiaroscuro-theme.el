...
(custom-theme-set-faces 'chiaroscuro
  ...
  `(magit-branch-current              ((t (:foreground ,green-A-1 :background ,green-A-2 :box (:line-width 1 :color ,green-A-1)                 ))))
  `(magit-branch-local                ((t (:foreground ,green-A-1 :background ,green-A-2 :box (:line-width 1 :color ,green-A-1)                 ))))
  `(magit-branch-remote               ((t (:foreground ,red-A-1 :background ,red-A-2 :box (:line-width 1 :color ,red-A-1)                 ))))
  `(magit-branch-remote-head          ((t (:foreground ,red-A-1 :background ,red-A-2 :box (:line-width 1 :color ,red-A-1)                 ))))
  `(magit-branch-upstream             ((t (:foreground ,red-A-1 :background ,red-A-2 :box (:line-width 1 :color ,red-A-1)                 ))))
  `(magit-section-highlight           ((t (                     :background ,background-B-1                        ))))
